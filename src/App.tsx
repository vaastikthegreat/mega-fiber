    ...
    <div className="container mx-auto px-8 relative z-10 flex flex-col md:flex-row items-center">
      <div className="md:w-1/2 mb-12 md:mb-0">
        ...
        <div className="flex items-baseline mb-4">
          <h1 className="text-8xl md:text-[150px] font-black text-slate-900 leading-none tracking-tighter">1000</h1>
          <span className="text-2xl md:text-3xl font-bold text-white bg-slate-800 px-4 py-2 ml-2 rounded-md">Mbps</span>
        </div>
        <h3 className="text-2xl md:text-3xl font-bold text-slate-800 mb-8 uppercase">Starts From ₹399 Per Month</h3>
      ...
      <div className="md:w-1/2 relative">
        <img src="https://images.unsplash.com/photo-1511895426328-dc8714191300?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Happy Family" className="relative z-10 rounded-2xl shadow-2xl object-cover h-[300px] md:h-[450px] w-full" referrerPolicy="no-referrer" />
      </div>
    </div>
  </div>
);
  ...
  <div className="py-20 bg-white relative overflow-hidden border-t border-gray-100">
    <div className="container mx-auto px-8 flex flex-col md:flex-row items-center justify-between relative z-10">
      ...
      <div className="md:w-1/2 relative w-full">
        ...
        <img src="https://images.unsplash.com/photo-1593508512255-86ab42a8e620?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="VR Gaming" className="rounded-xl shadow-xl object-cover h-[300px] w-full" referrerPolicy="no-referrer" />
      </div>
    </div>
  </div>
);
  ...
  <div className="py-24 bg-white relative overflow-hidden">
    ...
    <div className="container mx-auto px-8 flex flex-col md:flex-row items-center relative z-10">
      <div className="md:w-1/2 mb-10 md:mb-0 relative w-full">
        <img src="https://images.unsplash.com/photo-1616423640778-28d1b53229bd?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Service Van" className="rounded-xl shadow-2xl object-cover h-[350px] w-full relative z-10" referrerPolicy="no-referrer" />
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <input type="text" required className="w-full px-4 py-2 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500" placeholder="John Doe" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Contact Number *</label>
                <input type="tel" required className="w-full px-4 py-2 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500" placeholder="+91 9876543210" />
              </div>
              {modalType === 'plan' && (
                <div>
    ...
    <div className="container mx-auto px-8">
      ...
      <div className="mt-40 flex flex-col lg:flex-row items-center gap-16 relative">
        ...
        <div className="lg:w-1/2 relative w-full">
          ...
          <img src="https://images.unsplash.com/photo-1593784991095-a205069470b6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="TV Shows" className="rounded-xl shadow-2xl w-4/5 object-cover h-[500px] relative z-10" referrerPolicy="no-referrer" />
          
          <img src="https://images.unsplash.com/photo-1593305841991-05c297ba4575?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Remote Control" className="absolute top-1/4 -right-4 w-2/5 rounded-xl shadow-2xl border-4 border-white object-cover h-[200px] z-20" referrerPolicy="no-referrer" />
          ...
          <div className="absolute -bottom-10 -right-4 w-64 h-64 bg-emerald-600 rounded-full flex items-center justify-center border-8 border-white shadow-xl overflow-hidden z-30">
            <img src="https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Happy User" className="w-full h-full object-cover opacity-90 mix-blend-overlay" referrerPolicy="no-referrer" />
      ...
      <div className="relative py-24 mb-32">
        ...
        <div className="container mx-auto px-8 relative z-10 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <img src="https://images.unsplash.com/photo-1593305841991-05c297ba4575?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80" alt="Family watching TV" className="rounded-2xl shadow-2xl object-cover h-[400px] w-full" referrerPolicy="no-referrer" />
          </div>
      ...
      <div className="container mx-auto px-8 relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
          ...
          <div className="lg:w-1/2 w-full relative flex justify-center mt-12 lg:mt-0">
            ...
            <img src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Woman using laptop" className="relative z-10 w-4/5 object-cover rounded-2xl drop-shadow-2xl" referrerPolicy="no-referrer" />
          </div>
        </div>
      </div>
